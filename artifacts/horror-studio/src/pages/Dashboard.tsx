...
const TOOLS = [
  ...
  },
  {
    ...
    desc: "Local AI chatbot powered by your PC — run LLMs like Llama, Mistral, GLM offline, free & private",
    color: "green",
  ...
  },
  {
    ...
    desc: "Generate creepy horror voices, clone characters & create TTS audio for OBS streams",
    color: "orange",
  ...
  {
    path: "/pinokio-launcher",
    icon: "🚀",
    title: "Pinokio Launcher",
    desc: "One-click launcher for AI apps — install & run ComfyUI, Stable Diffusion and more with ease",
    color: "yellow",
